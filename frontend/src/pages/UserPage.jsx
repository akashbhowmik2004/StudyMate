...
import { FaPlus, FaComment, FaThumbsUp, FaShare, FaUsers, FaHome, FaSearch, FaClock, FaTimes } from 'react-icons/fa';
...
const UserPage = () => {
  ...
  const posts = [
    {
      ...
      avatar: 'AJ',
      time: '2 hours ago',
      content: 'How do I solve complex integral problems? I struggle with substitution methods.',
      likes: 24,
      comments: 5,
    ...
    },
    {
      ...
      avatar: 'SC',
      time: '4 hours ago',
      content: 'Need help understanding quantum mechanics. Specifically the wave-particle duality concept.',
      likes: 18,
      comments: 8,
      community: 'Physics'
    },
    {
      ...
      avatar: 'MD',
      time: '6 hours ago',
      content: 'What are the best resources for learning React? Currently working on a project.',
      likes: 42,
      comments: 12,
  ...
  const communities = [
    { id: 1, name: 'Mathematics', members: 2543, description: 'Discuss math problems and solutions' },
    { id: 2, name: 'Physics', members: 1834, description: 'Physics concepts and experiments' },
    { id: 3, name: 'Technology', members: 3421, description: 'Tech discussions and learning' },
    { id: 4, name: 'Chemistry', members: 1256, description: 'Chemistry topics and reactions' }
  ];

  const comments = [
    { id: 1, author: 'John Smith', avatar: 'JS', text: 'Try using partial fractions method!', time: '1 hour ago' },
    { id: 2, author: 'Emma Wilson', avatar: 'EW', text: 'This helped me too, great suggestion!', time: '30 mins ago' }
  ];
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow p-4 sticky top-24">
              <div className="mb-6">
                ...
                <h3 className="text-center font-semibold text-gray-900">John Doe</h3>
                            ...
                            {comments.map(comment => (
                              <div key={comment.id} className="flex gap-3">
                                <div className="w-8 h-8 bg-gradient-to-br from-green-500 to-teal-500 rounded-full flex-shrink-0 flex items-center justify-center">
                                  <span className="text-white font-bold text-xs">{comment.avatar}</span>
                                </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  {communities.map(community => (
                    <div key={community.id} className="bg-white rounded-lg shadow p-4 hover:shadow-md transition-shadow">
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex items-start gap-4 flex-1">
                          ...
                          <div>
                            <h4 className="font-semibold text-gray-900 text-lg">{community.name}</h4>
                            <p className="text-sm text-gray-600">{community.description}</p>
                            <p className="text-xs text-gray-500 mt-2">{community.members.toLocaleString()} members</p>
                          </div>
                        </div>
                      </div>
            ...
            <div className="bg-white rounded-lg shadow p-4 sticky top-24">
              ...
              <div className="space-y-3">
                <div className="p-3 hover:bg-gray-50 rounded-lg cursor-pointer transition-colors">
                  <div className="text-sm font-semibold text-gray-900"># Calculus</div>
                  <div className="text-xs text-gray-600">2.5K posts</div>
                </div>
                <div className="p-3 hover:bg-gray-50 rounded-lg cursor-pointer transition-colors">
                  <div className="text-sm font-semibold text-gray-900"># Organic Chemistry</div>
                  <div className="text-xs text-gray-600">1.8K posts</div>
                </div>
                <div className="p-3 hover:bg-gray-50 rounded-lg cursor-pointer transition-colors">
                  <div className="text-sm font-semibold text-gray-900"># Programming</div>
                  <div className="text-xs text-gray-600">3.2K posts</div>
                </div>
                <div className="p-3 hover:bg-gray-50 rounded-lg cursor-pointer transition-colors">
                  <div className="text-sm font-semibold text-gray-900"># STEM</div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-lg max-w-md w-full">
            <div className="flex items-center justify-between p-6 border-b border-gray-200">
              <h2 className="text-xl font-bold text-gray-900">Post Your Doubt</h2>
              <button
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Your Doubt</label>
                <textarea
